...
values (now(), now(), 'admin@email.com', '1234', '관리자', '00000000000'),
       ...
       (now(), now(), 'hyeonic@gmail.com', '1234', 'hyeonic', '00000000003'),
...
values (now(), now(), '홍길동짐', '부천시 중동로 165번길 22', '넓은 평수, 다수의 기구 보유', '010-0000-0000', 11),
...
values (now(), now(), 17, 7, '나는 기현 멋짐에서 pt중'),
       (now(), now(), 18, 7, '자격증 보유'),
       (now(), now(), 19, 7, '자격증 보유'),
